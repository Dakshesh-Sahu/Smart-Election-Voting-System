...
while True:
    ...
    # === New insertion logic to fit left panel ===
    resized_frame = cv2.resize(frame, (552, 414))  # Resize frame to fit left half
    x_offset = 75
    y_offset = (684 - 414) // 2  # Center vertically → 105

    imgBackground[y_offset:y_offset + 414, x_offset:x_offset + 552] = resized_frame
